export const IOC_TYPE = {
  ...
  ProductProductBrandRepoImpl: Symbol.for('ProductProductBrandRepoImpl'),
  ...
  ShopCategoryRepoImpl: Symbol.for('ShopCategoryRepoImpl'),
  ...
  EditShopCategoryAction : Symbol.for('EditShopCategoryAction'),
  DeleteShopCategoryAction : Symbol.for('DeleteShopCategoryAction'),
  CreateShopCategoryAction : Symbol.for('CreateShopCategoryAction'),
  ...
  ProductProductBrandServiceImpl: Symbol.for('ProductProductBrandServiceImpl'),
