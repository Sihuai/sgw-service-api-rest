export const IOC_TYPE = {
  ...
  CartDetailRepoImpl: Symbol.for('CartDetailRepoImpl'),
  CartCartDetailRepoImpl: Symbol.for('CartCartDetailRepoImpl'),
  ...
  CartCartDetailServiceImpl: Symbol.for('CartCartDetailServiceImpl'),
