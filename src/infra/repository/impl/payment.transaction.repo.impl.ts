...
@provide(IOC_TYPE.PaymentTransactionRepoImpl)
export class PaymentTransactionRepoImpl implements PaymentTransactionRepo {
  async selectAll() : Promise<any> {
    const con = await createConnection({...ormSGWConnParam, entities: [PaymentTransaction]});

    try {
      const repo = con.repositoryFor<PaymentTransaction>("PaymentTransaction");
