  ...
  */
  ...
  private async create(
    ...
    try {
      ...
      if (result == -11) return response.status(ResponseDataCode.ValidationError).json(ResponseFailure(ResponseDataCode.ValidationError, 'Fail to cancel default address!'));
